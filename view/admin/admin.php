    ...
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-striped">
          <tr>
            <th><a href="index.php?hl=addadmin" class="btn btn-sm btn-info"><i class="ion ion-plus"></i></a>
            </th>
    ...
    <nav class="d-inline-block">
      <ul class="pagination mb-0">
        ...
        for ($i = 1; $i <= $jmlhalaman; $i++) {
          if ($i != $halaman) {
            echo "<li class='page-item'><a class='page-link' href='index.php?hl=admin&halaman=$i'>$i</a></li>";
          } else {
