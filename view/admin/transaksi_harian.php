        ...
        <div class="card-body">
            <div class="table-responsive">
                <form action="" method="post" class="mb-3">
                    <div class="row ">
                        <div class="col-lg-3 ">
                            <input type="date" name="tanggal" class="form-control mb-2" value="<?= date('Y-m-d') ?>"
                                required>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-2 pl-0">
                            <a href="report_transaksi_harian.php?hari=<?= $_POST['tanggal'] ?>" target="_blank" class="btn btn-warning">Cetak Data</a>
                        </div>
                    </div>
                </form>
                <table class="table table-striped">
                    ...
                    if (isset($_POST['cari'])) {
                        ...
                        WHERE DAY(booking.tgl_booking) = '$hari' AND MONTH(booking.tgl_booking) = '$bulan' AND YEAR(booking.tgl_booking) = '$tahun'
