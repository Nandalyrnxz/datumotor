            ...
            <form method="post" action="" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <select name="type_mobil" id="" class="form-control">
                    ...
                    <div class="col-lg-12">
                        <input type="submit" value="Kirim" name="konsul" class="btn btn-sm btn-success">
...
if (isset($_POST['konsul'])) {
    ...
    $phone = '62' . $data['no_wa'];
    $pesan = "Konsultasi Datu Motor \nMerek Mobil: $id_mobil \nType Mobil : $type_mobil \nTahun Keluaran: $tahun \nTingkat Kerusakan : $kerusakan \nKeluhan : $keluhan";
    ...
    if ($response) {
        ...
        echo "<script type='text/javascript'>
			...
			swal({
				title: 'Sukses',
				text:  'Pesan terkirim via Whatsapps',
				icon: 'success',
				timer: 1000,
