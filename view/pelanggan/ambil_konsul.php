			...
			<table class="table">
				<tr>
					...
					<td>
						...
						$cariidpelanggan=mysqli_query($conn,"select id_pelanggan from pelanggan where id_pelanggan='$id_pelanggan'");
						$res=mysqli_fetch_array($cariidpelanggan);
						$idpelanggan=$res['id_pelanggan'];


						if($idpelanggan){
							echo "<input class='form-control' type='text' id='id_pelanggan' name='id_pelanggan' 
						value='$id_pelanggan'  readonly>";
						}else{
							echo "<input class='form-control' type='text' id='id_pelanggan' name='id_pelanggan' 
